...
contract DiamondCutFacet is Base, IDiamondCut {
    ...
    function proposeDiamondCut(
        Diamond.FacetCut[] calldata _facetCuts,
    ...
    function cancelDiamondCutProposal() external onlyOwner {
    ...
    function executeDiamondCutProposal(
        ...
        require(
            s.diamondCutStorage.proposedDiamondCutHash ==
                keccak256(
                    abi.encode(_diamondCut.facetCuts, _diamondCut.initAddress)
                ),
            "a4"
    ...
    function emergencyFreezeDiamond() external onlyOwner {
        Diamond.DiamondStorage storage diamondStorage = Diamond
            .getDiamondStorage();
    ...
    function unfreezeDiamond() external onlyOwner {
        Diamond.DiamondStorage storage diamondStorage = Diamond
            .getDiamondStorage();
