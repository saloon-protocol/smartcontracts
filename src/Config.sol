...
uint256 constant L2_TO_L1_LOGS_COMMITMENT_BYTES = 4 +
...
uint256 constant PRIORITY_EXPIRATION = PRIORITY_EXPIRATION_PERIOD /
    BLOCK_PERIOD; //NOTE WRONG VALUE
...
uint256 constant COMMIT_TIMESTAMP_APPROXIMATION_DELTA = 1; //NOTE WRONG VALUE
